...
<html lang="en">
    <head>
        ...
        <title>Daily Junior Quiz | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
                ...
                <div class="right_col" role="main">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Daily Junior Quiz <small>Create New Quiz</small></h2>
                                ...
                                <div class="x_content">                                   
                                    ...
                                    <div class='row'>
                                        ...
                                        <div class='col-md-3'>
                                            <?php
                                            $sql = "SELECT * FROM junior_category ORDER BY id + 0 ASC";
                                            $db->sql($sql);
                                            $res = $db->getResult();
                                            ?>
                                    ...
                                    <div class='row'>
                                        <div class='col-md-6'>
                                            ...
                                            <table aria-describedby="mydesc" class='table-striped' id='questions'
                                                   data-toggle="table"
                                                   data-url="get-list.php?table=junior_question"
                                        ...
                                        <div class='col-md-5'>
                                            ...
                                            <form id="daily_quiz_form" method="POST" action="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                                <input type="hidden" id="update_daily_quiz_order" name="update_daily_quiz_order_junior" required value='1'/>
        ...
        <script>
            ...
            function load_sortable_ui(date, language_id) {
                ...
                $.ajax({
                    ...
                    data: 'get_selected_date_junior=1&selected_date=' + selected_date + '&language_id=' + language_id,
                    beforeSend: function () {

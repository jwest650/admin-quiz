                            ...
                            <div class="x_content">
                                <div class='row'>
                                    ...
                                    <div class='col-md-12'>
                                        ...
                                        <table aria-describedby="mydesc" class='table-striped' id='category_list' data-toggle="table" data-url="get-list.php?table=junior_subcategory" data-sort-name="row_order" data-sort-order="asc" data-click-to-select="true" data-side-pagination="server" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-toolbar="#toolbar" data-mobile-responsive="true" data-maintain-selected="true" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-export="false" data-export-types='["txt","excel"]' data-export-options='{
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="update_form" method="POST" action="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                            <input type='hidden' name="update_junior_subcategory" id="update_subcategory" value='1' />
        ...
        $(document).on('click', '.delete-subcategory', function() {
            if (confirm('Are you sure? Want to delete sub category? All related questions will also be deleted')) {
                ...
                $.ajax({
                    url: 'db_operations.php',
                    type: "get",
                    data: 'id=' + id + '&image=' + image + '&delete_junior_subcategory=1',
                    success: function(result) {
                        if (result == 1) {

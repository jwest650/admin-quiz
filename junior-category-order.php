                    ...
                    <div class="row">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                $sql = "SELECT * FROM junior_category WHERE type=" . $type . " ORDER BY CAST(row_order as unsigned) ASC";
                                $db->sql($sql);
                                $cat = $db->getResult();
                                ?>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <form id="category_form" method="POST" action="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                        <input type="hidden" id="update_category_order" name="update_junior_category_order" required value='1' />
                                ...
                                <?php
                                $db->sql("SET NAMES 'utf8'");
                                $sql = "SELECT s.* FROM junior_subcategory s JOIN category c ON c.id=s.maincat_id WHERE c.type=" . $type . " ORDER BY CAST(s.row_order as unsigned) ASC";
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <form id="subcategory_form" method="POST" action="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                                        <input type="hidden" id="update_subcategory_order" name="update_junior_subcategory_order" required value='1' />
                                        <div class="form-group" style="overflow-y:scroll;height:400px;">
        ...
        <script>
            ...
            $('#filter_language').on('change', function (e) {
                ...
                $.ajax({
                    ...
                    data: 'get_junior_categories_of_language=1&sortable=sortable&language_id=' + lang_id + '&type=' + type,
                    success: function (result) {
        ...
        <script>
            $('#filter_category').on('change', function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "db_operations.php",
                    data: 'get_junior_subcategories_of_category=1&sortable=sortable&category_id=' + category_id,
                    success: function (result) {

                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="novalidate">
                                    <input type="hidden" id="add_learning" name="add_junior_learning" required value="1" aria-required="true">
                                    <input type="hidden" name="type" value="<?= $type ?>" required>
                                    <?php
                                    $db->sql("SET NAMES 'utf8'");
                                    $sql = "SELECT * FROM junior_category WHERE type=" . $type . " ORDER BY id DESC";
                                    $db->sql($sql);
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <input name="pdf_file" type="file" class="form-control" accept="application/pdf" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-12 col-sm-12">
                            ...
                            <table aria-describedby="mydesc" class='table-striped' id='learnings' data-toggle="table" data-url="get-list.php?table=junior_learning_zone" data-sort-name="id" data-sort-order="desc" data-click-to-select="true" data-side-pagination="server" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-toolbar="#toolbar" data-mobile-responsive="true" data-maintain-selected="true" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-show-export="false" data-export-types='["txt","excel"]' data-export-options='{
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" data-field="pdf_file" data-sortable="false" data-visible='false'>PDF File</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="update_form" method="POST" action="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <input type='hidden' name="update_junior_learning" id="update_learning" value='1' />
                        <?php
                        $db->sql("SET NAMES 'utf8'");
                        if ($fn->is_language_mode_enabled()) {
                        ?>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-sm-12">
                                <label>Upload PDF File</label>
                                <input name="edit_pdf_file" type="file" class="form-control" accept="application/pdf" />
                                <input type="hidden" name="edit_pdf" id="edit_pdf">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-12 col-sm-12">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="update_status_form" method="POST" action="db_operations.php" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <input type='hidden' name="update_junior_learning_status" id="update_learning_status" value='1' />
    ...
    <script>
        window.actionEvents = {
            'click .edit-data': function(e, value, row, index) {
                ...
                // var hrefValue = document.getElementById("get_pdf").attr("data-name");
        ...
        $(document).on('click', '.delete-data', function() {
            if (confirm('Are you sure? Want to delete learning? All related questions will also be deleted')) {
                ...
                $.ajax({
                    url: 'db_operations.php',
                    type: "get",
                    data: 'id=' + id + '&pdf=' + pdf + '&delete_junior_learning=1',
                    success: function(result) {
                        if (result == 1) {

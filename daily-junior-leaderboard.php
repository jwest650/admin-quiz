...
<html lang="en">
    <head>
        ...
        <title>Daily Leaderboard Details  | <?= ucwords($_SESSION['company_name']) ?> - Admin Panel </title>
    ...
    <body class="nav-md">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <table aria-describedby="mydesc" class='table-striped' id='daily_junior_leaderboard'
                                           data-toggle="table"
                                           data-url="get-list.php?table=daily_junior_leaderboard"
                                           ...
                                           data-export-options='{
                                           "fileName": "daily-leaderboard-list-<?= date('d-m-y') ?>",
                                           "ignoreColumn": ["state"]	
                                           }'
        ...
        <!-- jQuery -->
        <script>
            var $table = $('#daily_junior_leaderboard');

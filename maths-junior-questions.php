                            ...
                            <div class="x_content">
                                <div class="row">
                                    <form id="register_form" method="POST" action="db_operations.php" data-parsley-validate="" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate="novalidate">
                                        ...
                                        ?>
                                                <input type="hidden" id="image_url" name="image_url" value="<?= ($res[0]['image']) ? 'images/maths-question/' . $res[0]['image'] : ''; ?>" aria-required="true">
                                            <?php
                                            }
                                        }
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-1">
                                                <button type="submit" id="submit_btn" class="btn btn-success"><?= (!empty($res))  ? "Update" : 'Create Now' ?></button>
                                            </div>
                                        </div>
                                        <div class="row">
